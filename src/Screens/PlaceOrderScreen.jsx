...
const PlaceOrderScreen = ({ history }) => {
    ...
    return (
        <>
            {loading && <Loader />}
            {success ? <Message>Order added successfully</Message> : ''}
                    ...
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            <p>
                                ...
                                {' '}{userLogin.shippingAddress.address},{' '}{userLogin.shippingAddress.city},{' '}{userLogin.shippingAddress.postalCode},{' '}{userLogin.shippingAddress.country}
                            </p>
                        </ListGroup.Item>
                        <ListGroup.Item>
